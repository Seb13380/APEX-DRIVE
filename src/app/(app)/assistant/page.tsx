...
export default function AssistantPage() {
  ...
  async function envoyerNote(audio: Blob) {
    ...
    const { data, error } = await supabase.functions.invoke("webhook-note-entrante", {
      body: { audio_path: chemin, client_id: null },
    });

    if (error) {
      setEtat("erreur");
      setMessage(`Échec du traitement IA : ${error.message}`);
      return;
    }
